---
description: 'Runs test commands for any language and reports results. For the trading-bot project, runs pytest and reports pass/fail. Discovers test command from project files if not specified.'
...
This is a Python 3.10+ project using **`pytest`** and **`pytest-asyncio`** for tests.
- Test files are in `test/` directory
- Run: `pytest test/ -v`
- For a specific file: `pytest test/test_candles.py -v`
